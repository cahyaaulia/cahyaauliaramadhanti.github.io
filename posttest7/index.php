...
<body>
    ...
    <main>
        ...
        <section class="products">
            <h2>Daftar Produk</h2>
            <div class="product"> 
                <img src="cicin1.webp" width="30%" alt="Cincin 1">
                ...
                <div class="product2">
                <img src="kalung1.webp" width="30%" alt="Kalung 1">
                ...
                <div class="product3">
                <img src="1.jpg" width="30%" alt="Kalung 1">
                <h3>Kalung Mutiara Mewah</h3>
                <p>Kalung mutiara mewah dengan tali emas.</p>
                <p>Harga: Rp 8.000.000</p>
                <button>Beli</button>
                ...
                <div class="product4">
                <img src="2.jpg" width="30%" alt="Kalung 1">
                <h3>Kalung Mutiara Mewah</h3>
                <p>Kalung mutiara mewah dengan tali emas.</p>
                <p>Harga: Rp 8.000.000</p>
                <button>Beli</button>
                ...
                <div class="product5">
                <img src="3.jpg" width="30%" alt="Kalung 1">
                <h3>Kalung Mutiara Mewah</h3>
                <p>Kalung mutiara mewah dengan tali emas.</p>
                <p>Harga: Rp 8.000.000</p>
                <button>Beli</button>
                ...
                <div class="product6">
                <img src="4.jpeg" width="30%" alt="Kalung 1">
                <h3>Kalung Mutiara Mewah</h3>
                <p>Kalung mutiara mewah dengan tali emas.</p>
                <p>Harga: Rp 8.000.000</p>
                <button>Beli</button>
